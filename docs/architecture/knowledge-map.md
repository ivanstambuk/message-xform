...
| `docs/operations/pingam-operations-guide.md` | PingAM operations, custom Docker image (WAR on Tomcat), vendor Dockerfile limitations, rebuild playbook | Infrastructure (identity provider for E2E) |
