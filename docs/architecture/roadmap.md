...
| 002 | PingAccess Adapter | ✅ Complete | `features/002/spec.md` | Feature 001 | Java 21 (PA SDK 9.0) |
| 003 | PingGateway Adapter | 🔬 Research | `features/003/spec.md` | Feature 001 | Java / Groovy |
