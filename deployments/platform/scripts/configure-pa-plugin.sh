...
echo "  Profile:  platform-am"
echo "  Specs:    am-auth-response, am-header-inject"
echo ""
echo "  Transform behaviour:"
echo "    /am/json/authenticate (POST) → response body cleaned up"
echo "    /am/json/**                  → X-Auth-Provider header added"
echo ""
echo "  Test:"
