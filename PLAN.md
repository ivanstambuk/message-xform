...
- [x] **Core byte-boundary refactor (Anti-Corruption Layer)** — ✅ Phases 0–4 + 5.1 complete. Core hides Jackson behind `byte[]`/`Map` boundary (ADR-0032, ADR-0033), bundles and relocates its own copy. 56 files changed, 468 tests green. Remaining: Phase 5.2 (PA adapter, deferred to Feature 002) and Phase 7 (cleanup). Plan: `docs/research/core-byte-boundary-plan.md`.
