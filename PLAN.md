...
- [x] **Core byte-boundary refactor (Anti-Corruption Layer)** — ✅ Complete. Core hides Jackson behind `byte[]`/`Map` boundary (ADR-0032, ADR-0033), bundles and relocates its own copy. Jackson upgraded to 2.21.0 LTS.
